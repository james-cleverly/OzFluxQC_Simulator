...
def LRFBinFilters(cf,ds):
    ...
    metutils.CreateSeries(ds,'Sws0Es0',Es0,FList=[InVar],Descr='',Units='umol/(m2 s)')
    metutils.CreateSeries(ds,'Sws0Es100',Es100,FList=[InVar],Descr='',Units='umol/(m2 s)')
    metutils.CreateSeries(ds,'Sws0Es200',Es200,FList=[InVar],Descr='',Units='umol/(m2 s)')
    metutils.CreateSeries(ds,'Sws0Es300',Es300,FList=[InVar],Descr='',Units='umol/(m2 s)')
    metutils.CreateSeries(ds,'Sws0Es400',Es400,FList=[InVar],Descr='',Units='umol/(m2 s)')
    metutils.CreateSeries(ds,'Sws0Es500',Es500,FList=[InVar],Descr='',Units='umol/(m2 s)')
    metutils.CreateSeries(ds,'Sws0Es600',Es600,FList=[InVar],Descr='',Units='umol/(m2 s)')
    metutils.CreateSeries(ds,'Sws0Es700',Es700,FList=[InVar],Descr='',Units='umol/(m2 s)')
    metutils.CreateSeries(ds,'Sws0Es800',Es800,FList=[InVar],Descr='',Units='umol/(m2 s)')
    metutils.CreateSeries(ds,'Sws0Es900',Es900,FList=[InVar],Descr='',Units='umol/(m2 s)')
    ...
    metutils.CreateSeries(ds,'Sws5Es0',Es0,FList=[InVar],Descr='',Units='umol/(m2 s)')
    metutils.CreateSeries(ds,'Sws5Es100',Es100,FList=[InVar],Descr='',Units='umol/(m2 s)')
    metutils.CreateSeries(ds,'Sws5Es200',Es200,FList=[InVar],Descr='',Units='umol/(m2 s)')
    metutils.CreateSeries(ds,'Sws5Es300',Es300,FList=[InVar],Descr='',Units='umol/(m2 s)')
    metutils.CreateSeries(ds,'Sws5Es400',Es400,FList=[InVar],Descr='',Units='umol/(m2 s)')
    metutils.CreateSeries(ds,'Sws5Es500',Es500,FList=[InVar],Descr='',Units='umol/(m2 s)')
    metutils.CreateSeries(ds,'Sws5Es600',Es600,FList=[InVar],Descr='',Units='umol/(m2 s)')
    metutils.CreateSeries(ds,'Sws5Es700',Es700,FList=[InVar],Descr='',Units='umol/(m2 s)')
    metutils.CreateSeries(ds,'Sws5Es800',Es800,FList=[InVar],Descr='',Units='umol/(m2 s)')
    metutils.CreateSeries(ds,'Sws5Es900',Es900,FList=[InVar],Descr='',Units='umol/(m2 s)')
        
    #Ts bins%
    Es0 = numpy.ma.masked_where(Fsd > 100,Fc1)
    Ts6Es0 = numpy.ma.masked_where(Ts > 16,Es0)
    Ts16Es0 = numpy.ma.masked_where((Ts < 16) | (Ts > 26),Es0)
    Ts26Es0 = numpy.ma.masked_where((Ts < 26) | (Ts > 36),Es0)
    Ts36Es0 = numpy.ma.masked_where((Ts < 36) | (Ts > 46),Es0)
    Ts46Es0 = numpy.ma.masked_where(Ts < 46,Es0)
    
    metutils.CreateSeries(ds,'Ts6Es0',Ts6Es0,FList=[InVar],Descr='',Units='umol/(m2 s)')
    metutils.CreateSeries(ds,'Ts16Es0',Ts16Es0,FList=[InVar],Descr='',Units='umol/(m2 s)')
    metutils.CreateSeries(ds,'Ts26Es0',Ts26Es0,FList=[InVar],Descr='',Units='umol/(m2 s)')
    metutils.CreateSeries(ds,'Ts36Es0',Ts36Es0,FList=[InVar],Descr='',Units='umol/(m2 s)')
    metutils.CreateSeries(ds,'Ts46Es0',Ts46Es0,FList=[InVar],Descr='',Units='umol/(m2 s)')
        
    Es100 = numpy.ma.masked_where((Fsd < 100) | (Fsd > 200),Fc1)
    Ts6Es100 = numpy.ma.masked_where(Ts > 16,Es100)
    Ts16Es100 = numpy.ma.masked_where((Ts < 16) | (Ts > 26),Es100)
    Ts26Es100 = numpy.ma.masked_where((Ts < 26) | (Ts > 36),Es100)
    Ts36Es100 = numpy.ma.masked_where((Ts < 36) | (Ts > 46),Es100)
    Ts46Es100 = numpy.ma.masked_where(Ts < 46,Es100)
    
    metutils.CreateSeries(ds,'Ts6Es100',Ts6Es100,FList=[InVar],Descr='',Units='umol/(m2 s)')
    metutils.CreateSeries(ds,'Ts16Es100',Ts16Es100,FList=[InVar],Descr='',Units='umol/(m2 s)')
    metutils.CreateSeries(ds,'Ts26Es100',Ts26Es100,FList=[InVar],Descr='',Units='umol/(m2 s)')
    metutils.CreateSeries(ds,'Ts36Es100',Ts36Es100,FList=[InVar],Descr='',Units='umol/(m2 s)')
    metutils.CreateSeries(ds,'Ts46Es100',Ts46Es100,FList=[InVar],Descr='',Units='umol/(m2 s)')
        
    Es200 = numpy.ma.masked_where((Fsd < 200) | (Fsd > 300),Fc1)
    Ts6Es200 = numpy.ma.masked_where(Ts > 16,Es200)
    Ts16Es200 = numpy.ma.masked_where((Ts < 16) | (Ts > 26),Es200)
    Ts26Es200 = numpy.ma.masked_where((Ts < 26) | (Ts > 36),Es200)
    Ts36Es200 = numpy.ma.masked_where((Ts < 36) | (Ts > 46),Es200)
    Ts46Es200 = numpy.ma.masked_where(Ts < 46,Es200)
    
    metutils.CreateSeries(ds,'Ts6Es200',Ts6Es200,FList=[InVar],Descr='',Units='umol/(m2 s)')
    metutils.CreateSeries(ds,'Ts16Es200',Ts16Es200,FList=[InVar],Descr='',Units='umol/(m2 s)')
    metutils.CreateSeries(ds,'Ts26Es200',Ts26Es200,FList=[InVar],Descr='',Units='umol/(m2 s)')
    metutils.CreateSeries(ds,'Ts36Es200',Ts36Es200,FList=[InVar],Descr='',Units='umol/(m2 s)')
    metutils.CreateSeries(ds,'Ts46Es200',Ts46Es200,FList=[InVar],Descr='',Units='umol/(m2 s)')
        
    Es300 = numpy.ma.masked_where((Fsd < 300) | (Fsd > 400),Fc1)
    Ts6Es300 = numpy.ma.masked_where(Ts > 16,Es300)
    Ts16Es300 = numpy.ma.masked_where((Ts < 16) | (Ts > 26),Es300)
    Ts26Es300 = numpy.ma.masked_where((Ts < 26) | (Ts > 36),Es300)
    Ts36Es300 = numpy.ma.masked_where((Ts < 36) | (Ts > 46),Es300)
    Ts46Es300 = numpy.ma.masked_where(Ts < 46,Es300)
    
    metutils.CreateSeries(ds,'Ts6Es300',Ts6Es300,FList=[InVar],Descr='',Units='umol/(m2 s)')
    metutils.CreateSeries(ds,'Ts16Es300',Ts16Es300,FList=[InVar],Descr='',Units='umol/(m2 s)')
    metutils.CreateSeries(ds,'Ts26Es300',Ts26Es300,FList=[InVar],Descr='',Units='umol/(m2 s)')
    metutils.CreateSeries(ds,'Ts36Es300',Ts36Es300,FList=[InVar],Descr='',Units='umol/(m2 s)')
    metutils.CreateSeries(ds,'Ts46Es300',Ts46Es300,FList=[InVar],Descr='',Units='umol/(m2 s)')
        
    Es400 = numpy.ma.masked_where((Fsd < 400) | (Fsd > 500),Fc1)
    Ts6Es400 = numpy.ma.masked_where(Ts > 16,Es400)
    Ts16Es400 = numpy.ma.masked_where((Ts < 16) | (Ts > 26),Es400)
    Ts26Es400 = numpy.ma.masked_where((Ts < 26) | (Ts > 36),Es400)
    Ts36Es400 = numpy.ma.masked_where((Ts < 36) | (Ts > 46),Es400)
    Ts46Es400 = numpy.ma.masked_where(Ts < 46,Es400)
    
    metutils.CreateSeries(ds,'Ts6Es400',Ts6Es400,FList=[InVar],Descr='',Units='umol/(m2 s)')
    metutils.CreateSeries(ds,'Ts16Es400',Ts16Es400,FList=[InVar],Descr='',Units='umol/(m2 s)')
    metutils.CreateSeries(ds,'Ts26Es400',Ts26Es400,FList=[InVar],Descr='',Units='umol/(m2 s)')
    metutils.CreateSeries(ds,'Ts36Es400',Ts36Es400,FList=[InVar],Descr='',Units='umol/(m2 s)')
    metutils.CreateSeries(ds,'Ts46Es400',Ts46Es400,FList=[InVar],Descr='',Units='umol/(m2 s)')
        
    Es500 = numpy.ma.masked_where((Fsd < 500) | (Fsd > 600),Fc1)
    Ts6Es500 = numpy.ma.masked_where(Ts > 16,Es500)
    Ts16Es500 = numpy.ma.masked_where((Ts < 16) | (Ts > 26),Es500)
    Ts26Es500 = numpy.ma.masked_where((Ts < 26) | (Ts > 36),Es500)
    Ts36Es500 = numpy.ma.masked_where((Ts < 36) | (Ts > 46),Es500)
    Ts46Es500 = numpy.ma.masked_where(Ts < 46,Es500)
    
    metutils.CreateSeries(ds,'Ts6Es500',Ts6Es500,FList=[InVar],Descr='',Units='umol/(m2 s)')
    metutils.CreateSeries(ds,'Ts16Es500',Ts16Es500,FList=[InVar],Descr='',Units='umol/(m2 s)')
    metutils.CreateSeries(ds,'Ts26Es500',Ts26Es500,FList=[InVar],Descr='',Units='umol/(m2 s)')
    metutils.CreateSeries(ds,'Ts36Es500',Ts36Es500,FList=[InVar],Descr='',Units='umol/(m2 s)')
    metutils.CreateSeries(ds,'Ts46Es500',Ts46Es500,FList=[InVar],Descr='',Units='umol/(m2 s)')
        
    Es600 = numpy.ma.masked_where((Fsd < 600) | (Fsd > 700),Fc1)
    Ts6Es600 = numpy.ma.masked_where(Ts > 16,Es600)
    Ts16Es600 = numpy.ma.masked_where((Ts < 16) | (Ts > 26),Es600)
    Ts26Es600 = numpy.ma.masked_where((Ts < 26) | (Ts > 36),Es600)
    Ts36Es600 = numpy.ma.masked_where((Ts < 36) | (Ts > 46),Es600)
    Ts46Es600 = numpy.ma.masked_where(Ts < 46,Es600)
    
    metutils.CreateSeries(ds,'Ts6Es600',Ts6Es600,FList=[InVar],Descr='',Units='umol/(m2 s)')
    metutils.CreateSeries(ds,'Ts16Es600',Ts16Es600,FList=[InVar],Descr='',Units='umol/(m2 s)')
    metutils.CreateSeries(ds,'Ts26Es600',Ts26Es600,FList=[InVar],Descr='',Units='umol/(m2 s)')
    metutils.CreateSeries(ds,'Ts36Es600',Ts36Es600,FList=[InVar],Descr='',Units='umol/(m2 s)')
    metutils.CreateSeries(ds,'Ts46Es600',Ts46Es600,FList=[InVar],Descr='',Units='umol/(m2 s)')
        
    Es700 = numpy.ma.masked_where((Fsd < 700) | (Fsd > 800),Fc1)
    Ts6Es700 = numpy.ma.masked_where(Ts > 16,Es700)
    Ts16Es700 = numpy.ma.masked_where((Ts < 16) | (Ts > 26),Es700)
    Ts26Es700 = numpy.ma.masked_where((Ts < 26) | (Ts > 36),Es700)
    Ts36Es700 = numpy.ma.masked_where((Ts < 36) | (Ts > 46),Es700)
    Ts46Es700 = numpy.ma.masked_where(Ts < 46,Es700)
    
    metutils.CreateSeries(ds,'Ts6Es700',Ts6Es700,FList=[InVar],Descr='',Units='umol/(m2 s)')
    metutils.CreateSeries(ds,'Ts16Es700',Ts16Es700,FList=[InVar],Descr='',Units='umol/(m2 s)')
    metutils.CreateSeries(ds,'Ts26Es700',Ts26Es700,FList=[InVar],Descr='',Units='umol/(m2 s)')
    metutils.CreateSeries(ds,'Ts36Es700',Ts36Es700,FList=[InVar],Descr='',Units='umol/(m2 s)')
    metutils.CreateSeries(ds,'Ts46Es700',Ts46Es700,FList=[InVar],Descr='',Units='umol/(m2 s)')
        
    Es800 = numpy.ma.masked_where((Fsd < 800) | (Fsd > 900),Fc1)
    Ts6Es800 = numpy.ma.masked_where(Ts > 16,Es800)
    Ts16Es800 = numpy.ma.masked_where((Ts < 16) | (Ts > 26),Es800)
    Ts26Es800 = numpy.ma.masked_where((Ts < 26) | (Ts > 36),Es800)
    Ts36Es800 = numpy.ma.masked_where((Ts < 36) | (Ts > 46),Es800)
    Ts46Es800 = numpy.ma.masked_where(Ts < 46,Es800)
    
    metutils.CreateSeries(ds,'Ts6Es800',Ts6Es800,FList=[InVar],Descr='',Units='umol/(m2 s)')
    metutils.CreateSeries(ds,'Ts16Es800',Ts16Es800,FList=[InVar],Descr='',Units='umol/(m2 s)')
    metutils.CreateSeries(ds,'Ts26Es800',Ts26Es800,FList=[InVar],Descr='',Units='umol/(m2 s)')
    metutils.CreateSeries(ds,'Ts36Es800',Ts36Es800,FList=[InVar],Descr='',Units='umol/(m2 s)')
    metutils.CreateSeries(ds,'Ts46Es800',Ts46Es800,FList=[InVar],Descr='',Units='umol/(m2 s)')
        
    Es900 = numpy.ma.masked_where(Fsd < 900,Fc1)
    Ts6Es900 = numpy.ma.masked_where(Ts > 16,Es900)
    Ts16Es900 = numpy.ma.masked_where((Ts < 16) | (Ts > 26),Es900)
    Ts26Es900 = numpy.ma.masked_where((Ts < 26) | (Ts > 36),Es900)
    Ts36Es900 = numpy.ma.masked_where((Ts < 36) | (Ts > 46),Es900)
    Ts46Es900 = numpy.ma.masked_where(Ts < 46,Es900)
    
    metutils.CreateSeries(ds,'Ts6Es900',Ts6Es900,FList=[InVar],Descr='',Units='umol/(m2 s)')
    metutils.CreateSeries(ds,'Ts16Es900',Ts16Es900,FList=[InVar],Descr='',Units='umol/(m2 s)')
    metutils.CreateSeries(ds,'Ts26Es900',Ts26Es900,FList=[InVar],Descr='',Units='umol/(m2 s)')
    metutils.CreateSeries(ds,'Ts36Es900',Ts36Es900,FList=[InVar],Descr='',Units='umol/(m2 s)')
    metutils.CreateSeries(ds,'Ts46Es900',Ts46Es900,FList=[InVar],Descr='',Units='umol/(m2 s)')
